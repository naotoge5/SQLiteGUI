<main class="m-6 __mx-md-ex">
    ...
    <nav class="UnderlineNav mt-6">
        <div class="UnderlineNav-body">
            <a class="UnderlineNav-item" href="../">Structure</a>
            <a class="UnderlineNav-item __hover-pointer" aria-current="page">Content</a>
        </div>
    </nav>
    <!-- Name -->
    <div class="form-group">
        ...
        <div class="form-group-body">
            <input class="form-control" type="text" name="table-name" placeholder="name" value="" />
        </div>
    </div>
    <!-- /Name -->
    <!-- Columns -->
    ...
    <div class="form-group">
        ...
        <div class="form-group-body">
            <code>
                <textarea class="form-control" name="table-schema" readonly placeholder="schema"></textarea>
            </code>
        </div>
    </div>
    <form id="Create" action="controller/_new.php" method="post">
        <button class="btn btn-block" type="submit">Create Table</button>
    </form>
</main>